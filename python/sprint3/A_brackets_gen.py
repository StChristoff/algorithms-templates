...
def brackets_gen(counter, b1, b2, prefix):
    if b1 == 0
    #if b1 == 0 and b2 == 0:
        print(prefix)
    else:
        if b1 > 0:
            brackets_gen(counter + 1, b1 - 1, b2, prefix + '(')
        if (counter > 0 and b2 > 0):
            brackets_gen(counter - 1, b1, b2 - 1, prefix + ')') 
n = int(input())
counter = 0
b1 = b2 = n
brackets_gen(counter, b1, b2, '')
